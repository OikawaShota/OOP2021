...
namespace AddressBook
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: このコード行はデータを 'infosys202104DataSet.Person' テーブルに読み込みます。必要に応じて移動、または削除をしてください。
            this.personTableAdapter.Fill(this.infosys202104DataSet.Person);
            //this.personTableAdapter.FillByName(this.infosys202104DataSet.Person, "秀");
        }

        private void btNamefilter_Click(object sender, EventArgs e)
        {
            this.personTableAdapter.FillByName(this.infosys202104DataSet.Person, tbNamesearch.Text);
        }
        ...
        private void btSave_Click(object sender, EventArgs e)
        {
            ...
            this.Validate();
            this.personBindingSource.EndEdit();
            this.tableAdapterManager.UpdateAll(this.infosys202104DataSet); //すべて更新
        }
        ...
        private void btBirthdaysearch_Click(object sender, EventArgs e)
        {
            this.personTableAdapter.FillByBirthday(this.infosys202104DataSet.Person, dtpserch.Text);
        }
    }
}
